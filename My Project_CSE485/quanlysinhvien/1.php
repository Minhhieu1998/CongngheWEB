...
?>
 <form action="1.php" method="post" >
    ...
    <table style="background-color: grey; height: 350px;">
      <tr>
        <td colspan="2"><h3>Thêm bài viết mới</h3></td>
      </tr>
        <tr>
        <td nowrap="nowrap">Tiêu đề bài viết :</td>
        <td ><input style="width: 400px;height: 60px;margin-right: 190px;" type="text" id="title" name="title"></td>
      </tr>
      <tr>
        <td nowrap="nowrap">Nội dung :</td>
        <td ><textarea style="margin-right: 50px;" name="content" id="content" rows="8" cols="80" ></textarea></td>
      </tr>
      <tr>
